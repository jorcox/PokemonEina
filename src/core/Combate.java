...
public class Combate {
	...
	/**
	 * 
	 * Crea un combate pokemon entre un entrenador y un pokemon
	 * salvaje. Un entrenador podra jugar con los pokemon que
	 * tenga equipados.
	 * 
	...
	/**
	 * Contiene la funcionalidad de un combate pokemon, es decir,
	 * pregunta a cada turno que habilidad desea realizar el jugador
	 * y ejecuta la accion producida por su accion y por la del
	 * enemigo.
	 */
	...
	/**
	 * 
	 * El sistema decide que habilidad desea utilizar el pokemon
	 * enemigo.
	 * 
	 * @param enemigo el pokemon cuyo ataque se va a decidir.
	 * @return el indice de la habilidad que elige utilizar.
	 */
	private int decidir(Pokemon enemigo) {
	...
	/**
	 * 
	 * Realiza la accion de un pokemon haciendo una habilidad en combate.
	 * Su resultado modifica los puntos de vida o el estado de los pokemon
	 * implicados en el combate.
	 * 
	 * @param p1 el pokemon atacante.
	 * @param p2 el pokemon que es atacado.
	 * @param habilidad la habilidad que p1 realiza sobre p2.
	 */
	private void ejecutar(Pokemon p1, Pokemon p2, Habilidad habilidad) {
	...
	private void printDerrota() {
		System.out.println("A " + entrenador.getNombre() + " no le quedan mas pokemon! " +
				entrenador.getNombre() + " ha sido debilitado!");
	}

...
public class IntroducirDatos {
	...
	public void introducirPokemon(int i, int nivel) {
		try {
			db.update("INSERT INTO pokemon(nivel,nombre,tipo,ps,ataque,defensa,ataque_esp,defensa_esp,velocidad,mov1,mov2,mov3,mov4,experiencia,estado)"
					+ " VALUES(100, 'Sara','FIRE', 1000, 1000, 1000, 1000, 1000, 1000,100,25,53,400,0, 0)");
